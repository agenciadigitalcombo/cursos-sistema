                                            ...
                                            <td class="text-center">
                                                ...
                                                if ($pending_payout['status'] == "pending") : ?>
                                                    <?php if ($paypal_keys['production_client_id'] != "") : ?>
                                                        <form action="<?php echo site_url('addons/affiliate_course/paypal_checkout_for_affiliate_course_addon'); ?>" method="post">
                                                    ...
                                                    <?php if ($stripe_keys['public_live_key'] != "" && $stripe_keys['secret_live_key']) : ?>
                                                        <div id="buynow-<?php echo $pending_payout['id']; ?>"  class="height_c">
                                                    ...
                                                    <?php if ($razorpay_keys['key_id'] != "" && $razorpay_keys['secret_key']) : ?>
                                                        <form action="<?php echo site_url('addons/affiliate_course/razorpay_checkout_for_affiliate_course_addon/' . $pending_payout['user_id'] . '/' . $pending_payout['id']); ?>" method="post" class="razorpay-form form">

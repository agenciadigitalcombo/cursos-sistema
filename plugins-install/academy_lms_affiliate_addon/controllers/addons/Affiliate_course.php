...
class Affiliate_course extends CI_Controller
{
    ...
    public function paypal_checkout_for_affiliate_course_addon()
    {
        ...
        $page_data['amount_to_pay'] = html_escape($this->input->post('amount_to_pay'));
        $page_data['payout_id'] = html_escape($this->input->post('payout_id'));
        $page_data['instructor_name'] = html_escape($this->input->post('instructor_name'));
        $page_data['production_client_id'] = html_escape($this->input->post('production_client_id'));
    ...
    public function razorpay_checkout_for_affiliate_course_addon($user_id = '', $payout_id = '', $param1 = '', $razorpay_order_id = '', $payment_id = '', $amount = '', $signature = '')
    {
        ...
        $page_data['amount_to_pay'] = html_escape($this->input->post('total_price_of_checking_out'));

          ...
          <form action="<?php echo site_url('login/register'); ?>" method="post" id="sign_up">
            ...
            <div class="form-group" hidden>
              ...
              <div class="input-group">
                ...
                <input type="text" value=" " name="last_name" class="form-control" placeholder="<?php echo site_phrase('last_name'); ?>" aria-label="<?php echo site_phrase('last_name'); ?>" aria-describedby="<?php echo site_phrase('last_name'); ?>" id="last_name" required>
              </div>
            </div>
